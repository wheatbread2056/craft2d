...
const toolTiers = { // wooden, stone, coal, iron, gold, diamond, emerald, ruby, zyrite, developer (special)
    0: { durability: Infinity, efficiency: 0.05, damage: 1, level: 0 }, // hands (no tool)
    1: { durability: 32, efficiency: 0.1, damage: 3, level: 1 },
    2: { durability: 64, efficiency: 0.2, damage: 4, level: 2 },
    3: { durability: 128, efficiency: 0.15, damage: 5, level: 2 }, // special, pickaxe autosmelts ores & sword burns mobs
    4: { durability: 256, efficiency: 0.4, damage: 7, level: 3 },
    5: { durability: 512, efficiency: 0.7, damage: 9, level: 3},
    6: { durability: 1024, efficiency: 1.1, damage: 12, level: 4 },
    7: { durability: 2048, efficiency: 2.0, damage: 18, level: 5 },
...
const initialBlockList = [
    ...
    // bricks
    { id: 'bricks', name: 'Bricks', col: true, sel: true, h: 20 },
    { id: 'dirtbricks', name: 'Dirt Bricks', col: true, sel: true, h: 8 },
    { id: 'goldbricks', name: 'Gold Bricks', col: true, sel: true, h: 444 }, // good for defense, due to its high hardness.
    { id: 'stonebricks', name: 'Stone Bricks', col: true, sel: true, h: 25 },

    // planks
    { id: 'planks1', name: 'Autumn Planks', col: true, sel: true, h: 5 },
    { id: 'planks2', name: 'Meadow Planks', col: true, sel: true, h: 5 },
    { id: 'planks3', name: 'Woods Planks', col: true, sel: true, h: 5 },
    ...
    { id: 'sand', name: 'Sand', col: true, sel: true, h: 1 },
    { id: 'dirt', name: 'Dirt', col: true, sel: true, h: 1 },
    ...
    // grass (full blocks)
    { id: 'grass1', name: 'Autumn Grass', col: true, sel: true, h: 1.5 },
    { id: 'grass2', name: 'Meadow Grass', col: true, sel: true, h: 1.5 },
    { id: 'grass3', name: 'Woods Grass', col: true, sel: true, h: 1.5 },
    { id: 'grass4', name: 'Snowy Grass', col: true, sel: true, h: 1.8 },
    ...
    // logs
    { id: 'log1', name: 'Autumn Log', col: true, sel: true, h: 5 },
    { id: 'log2', name: 'Meadow Log', col: true, sel: true, h: 5 },
    { id: 'log3', name: 'Woods Log', col: true, sel: true, h: 5 },

    // stone types
    { id: 'stone1', name: 'Stone', col: true, sel: true, h: 10 },
    { id: 'stone2', name: 'Dark Stone', col: true, sel: true, h: 40 },
    { id: 'stone3', name: 'Very Dark Stone', col: true, sel: true, h: 160 },
    { id: 'stone4', name: 'Unbreakable Stone', col: true, sel: false }, // unbreakable stone

    // cobblestone types
    { id: 'cobblestone1', name: 'Cobblestone', col: true, sel: true, h: 15 },
    { id: 'cobblestone2', name: 'Dark Cobblestone', col: true, sel: true, h: 60 },
    { id: 'cobblestone3', name: 'Very Dark Cobblestone', col: true, sel: true, h: 200 },
    ...
    { id: 'ore_coal1', name: 'Coal Ore', col: true, sel: true, h: 12 },
    { id: 'ore_coal2', name: 'Dark Coal Ore', col: true, sel: true, h: 48 },
    { id: 'ore_coal3', name: 'Very Dark Coal Ore', col: true, sel: true, h: 192 },
    { id: 'ore_iron1', name: 'Iron Ore', col: true, sel: true, h: 16 },
    { id: 'ore_iron2', name: 'Dark Iron Ore', col: true, sel: true, h: 64 },
    { id: 'ore_iron3', name: 'Very Dark Iron Ore', col: true, sel: true, h: 256 },
    { id: 'ore_gold1', name: 'Gold Ore', col: true, sel: true, h: 24 },
    { id: 'ore_gold2', name: 'Dark Gold Ore', col: true, sel: true, h: 96 },
    { id: 'ore_gold3', name: 'Very Dark Gold Ore', col: true, sel: true, h: 384 },
    { id: 'ore_diamond1', name: 'Diamond Ore', col: true, sel: true, h: 48 },
    { id: 'ore_diamond2', name: 'Dark Diamond Ore', col: true, sel: true, h: 192 },
    { id: 'ore_diamond3', name: 'Very Dark Diamond Ore', col: true, sel: true, h: 768 },
    { id: 'ore_emerald1', name: 'Emerald Ore', col: true, sel: true, h: 72 },
    { id: 'ore_emerald2', name: 'Dark Emerald Ore', col: true, sel: true, h: 288 },
    { id: 'ore_emerald3', name: 'Very Dark Emerald Ore', col: true, sel: true, h: 1152 },
    { id: 'ore_ruby1', name: 'Ruby Ore', col: true, sel: true, h: 96 },
    { id: 'ore_ruby2', name: 'Dark Ruby Ore', col: true, sel: true, h: 384 },
    { id: 'ore_ruby3', name: 'Very Dark Ruby Ore', col: true, sel: true, h: 1536 },
    { id: 'ore_zyrite1', name: 'Zyrite Ore', col: true, sel: true, h: 128 },
    { id: 'ore_zyrite2', name: 'Dark Zyrite Ore', col: true, sel: true, h: 512 },
    { id: 'ore_zyrite3', name: 'Very Dark Zyrite Ore', col: true, sel: true, h: 2048 },
